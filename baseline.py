...
def main(args):
    ...
    register_coco_instances("deepsports_test", {},
                            os.path.join(args.dataset_path,"test.json"),
    ...
    if args.valid:
        # load model and weights
        model = build_model(cfg)
        DetectionCheckpointer(model).load(args.valid)
        # make dataloader
...
if __name__ == '__main__':
    ...
    parser.add_argument('--valid', default=None, type=str, help='provide model weights to evaluate modelon val set')
